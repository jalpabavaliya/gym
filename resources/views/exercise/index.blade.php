                    ...
                    <table class="table data-table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($exercise as $key => $exercise1) 
                                <tr>
                                    <td><iframe width="600" height="200" src="https://www.youtube.com/embed/{{ $exercise1->video_url }}" frameborder="0" full></iframe></td>
                                    <td>
                                        <a href="{{ route('exercise.edit', ['id' => $exercise1->id]) }}"><i class="fa fa-pencil aria-hidden="></i></a>&nbsp;&nbsp;&nbsp;
                                        <a href="{{ route('exercise.destroy', ['id' => $exercise1->id]) }}"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
