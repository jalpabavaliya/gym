...
<li class="nav-item active">
    ...
    <div class="collapse" id="ui-basic1">
        <ul class="nav flex-column sub-menu"><b style="color: white">FITNESS</b>
            ...
            <li class="nav-item active"> <a class="nav-link" href="{{ url('workouts') }}">Workouts</a></li>
            <li class="nav-item"> <a class="nav-link" href="#">Programs</a></li>
        </ul>
        <ul class="nav flex-column sub-menu active"><b style="color: white">NUTRITION</b>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Workouts Management</h4>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('workouts.list') }}",
        columns: [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},
            {data: 'workout_type', name: 'workout_type'},
            {data: 'total_exercise', name: 'total_exercise'},
            {data: 'est_time', name: 'est_time'},
