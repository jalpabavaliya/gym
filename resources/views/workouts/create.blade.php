...
@endif
{!! Form::open(array('route' => 'workouts.store','method'=>'POST')) !!}
<div class="row">
<div class="col-xs-12 col-sm-12 col-md-4">
        <div class="form-group">
            <strong>WorkOut Name:</strong>
            {!! Form::text('name', null, array('placeholder' => 'WorkOut Name','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-4">
        <div class="form-group">
            <strong>Workout Type:</strong>
            <select name="workout_type" class="form-group form-control">
