...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('exercise_categories.index') }}"> Back</a>
            </div>
        </div>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    {!! Form::model($exercise_categories, ['method' => 'PATCH','route' => ['exercise_categories.update', $exercise_categories->id]]) !!}
    <div class="row">
